...
const STORES = [
  ...
  'lubrication_records', 'anomalies', 'audit_log'
];

// app_config vive solo en el dispositivo (credenciales de conexión, cursores de sincronización)
const LOCAL_STORES = ['app_config'];
...
async function seedIfEmpty() {
  ...
  const users_seed = [
    ...
    { id: 'u_lub1', name: 'Junior Lubricador', username: 'lubricador', role: 'LUBRICADOR', pin: '4444', active: true }
  ];
